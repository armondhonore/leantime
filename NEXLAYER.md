...
**Live:** [https://relaxed-weasel-leantime.cloud.nexlayer.ai](https://relaxed-weasel-leantime.cloud.nexlayer.ai)  
...
**leantime** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/leantime/leantime:latest
    path: /
    servicePorts:
    - 8080
    vars:
      LEAN_DB_HOST: leantime-mysql-service
      LEAN_DB_USER: leantime
      LEAN_DB_PASSWORD: leantime
      LEAN_DB_DATABASE: leantime
      LEAN_EMAIL_RETURN: "armond@nexlayer.com"
      LEAN_SESSION_PASSWORD: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4"
      LEAN_APP_URL: "https://relaxed-weasel-leantime.cloud.nexlayer.ai"
    volumes:
    - name: leantime-uploads
